...
const tours = [
    ...
    { id: 6, name: "Bečići Resort & Spa", country: "Черногория", region: "europe", nights: 7, price: 780, oldPrice: 990, img: "https://avatars.mds.yandex.net/get-vertis-journal/4469561/faruk-kaymak-b_e5K7B3MzQ-unsplash.jpg_1702293405501/orig", desc: "Семейный отель, питание завтрак+ужин, близость пляжа. Живописные пейзажи Адриатики.", location: "Бечичи", rating: 4 },
